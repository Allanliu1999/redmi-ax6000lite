红米 xiaomi_redmi-router-ax6000固件，基于immortalwrt-24.10，linux内核版本6.6,闭源无线驱动，自带nikki、homeproxy，可修改代码增加自己需要的插件，直接fork即可云编译；

地址为192.168.99.1 需要修改的自行在diy-part2.sh文件第二十行里修改；第一版还是192.168.6.1
